          ...
          >
            <div className="relative aspect-video rounded-2xl bg-gray-900 px-5 py-3 shadow-xl before:pointer-events-none before:absolute before:-inset-5 before:border-y before:[border-image:linear-gradient(to_right,transparent,theme(colors.slate.300/.8),transparent)1] after:absolute after:-inset-5 after:-z-10 after:border-x after:[border-image:linear-gradient(to_bottom,transparent,theme(colors.slate.300/.8),transparent)1]">
              ...
              <div className="font-mono text-gray-500 [&_span]:opacity-0">
                <span className="animate-[code-1_10s_infinite] text-gray-200 delay-[0s]">
                  Report
                </span>{" "}
                <span className="animate-[code-2_10s_infinite] delay-[0s]">
                  --fill in a quick form
                </span>
                <br />
                <span className="animate-[code-1_10s_infinite] text-gray-200 delay-[2s]">
                  Assign
                </span>{" "}
                <span className="animate-[code-2_10s_infinite] delay-[2s]">
                  --fill in a quick form
                </span>
                <br />
                <span className="animate-[code-1_10s_infinite] text-gray-200 delay-[4s]">
                  Investigate
                </span>{" "}
                <span className="animate-[code-2_10s_infinite] delay-[4s]">
                  --fill in a quick form
                </span>
                <br />
                <span className="animate-[code-1_10s_infinite] text-gray-200 delay-[6s]">
                  Resolve
                </span>{" "}
                <span className="animate-[code-2_10s_infinite] delay-[6s]">
                  --fill in a quick form
                </span>
                <br />
                <span className="animate-[code-1_10s_infinite] text-gray-200 delay-[8s]">
                  Learn
                </span>{" "}
                <span className="animate-[code-2_10s_infinite] delay-[8s]">
                  --fill in a quick form
                </span>
                <br />
              </div>

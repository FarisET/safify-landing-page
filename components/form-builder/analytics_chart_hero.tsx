...
export default function AnalyticsChartHero() {
    ...
    return (
        <div className="absolute top-4 left-4 w-full sm:w-[350px] sm:h-[300px] md:w-[500px] md:h-[500px] mx-auto transform rotate-0 hover:rotate-0 transition-transform duration-300 scale-[0.92]">
